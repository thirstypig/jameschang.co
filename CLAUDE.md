...
**503 tests** across 13 files: 405 unit tests (12 files) + 98 E2E tests (1 file). Run locally with `python3 -m pytest tests/ -v` (requires `pytest`).

...
## Acceptance Criteria
- [x] Judge Tool repo CLAUDE.md `<!-- now-tldr -->` block uses "Barbeque" spelling
- [x] Next `projects-sync` cron run preserves "Barbeque" in `now/index.html`

## Work Log
- 2026-05-13: Identified during /ce:review. Cross-repo fix required (Judge Tool CLAUDE.md).
- 2026-05-13: Investigated — Judge Tool CLAUDE.md `<!-- now-tldr -->` already uses "barbeque" with no KCBS references. Cron ran today at 9:12 AM PT and produced correct output. No change needed.

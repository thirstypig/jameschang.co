...
- (b) TODAY: shipped 2026-07-24 (commit `059c941`) — generated by `bin/refresh-docs.py`
  into `under-the-hood/pm-review.md` and served as the docs-board landing view. Whether it
  actually becomes the weekly-review starting point is still [unknown].

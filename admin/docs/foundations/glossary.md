...
Define every project-specific term, acronym, and persona here — so a doc can use a term
once and link to its definition. A few examples to show the shape; fill in the rest.

| term | project(s) | meaning |
|---|---|---|
